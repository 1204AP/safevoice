...
//   {
//     id: 'situation',
//     question: "First, let me understand your situation. Which of these best describes where you are right now?",
//     options: [
//       "I'm still living with my abuser",
//       "I've left but need to stay safe",
...
//   const [step, setStep] = useState('start'); // 'start' | 'chat'
...
//         type: 'welcome',
//         content:
//           "I'm here to help you plan your safety — like a trusted friend who knows exactly what to do. Everything stays private on your device. Let's build your plan step by step.",
//       },
//       {
//         role: 'assistant',
//         type: 'options',
...
//       const data = res.data;
//       // Expect: { reply: string, options?: string[], followUpQuestion?: string, done?: bool }
//       const newMsgs = [
//         ...updatedMessages,
//         {
//           role: 'assistant',
...
//           type: 'text',
//           content:
//             "I'm having trouble connecting. Please try again, or call 181 (Women Helpline) immediately if you're in danger.",
//         },
//       ]);
//     }
//     setLoading(false);
...
//           role: 'assistant',
//           type: 'text',
//           content: 'Something went wrong. Call 181 for immediate help.',
//         },
//       ]);
//     }
//     setLoading(false);
...
//             Personalized Exit Planner
//           </h2>
//           <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '28px', lineHeight: '1.6' }}>
//             Answer a few brief questions to help us build a confidential checklist for your safety and independence.
//           </p>
...
//               <div>
//                 <div style={{ fontWeight: '600', fontSize: '13px', color: '#0f172a' }}>100% Private</div>
//                 <div style={{ fontSize: '12px', color: '#64748b' }}>Your answers are stored locally on this phone.</div>
//               </div>
//             </div>
//             <div style={{ display: 'flex', gap: '10px' }}>
//               <span style={{ color: '#0ea5e9', fontSize: '18px' }}>🛡</span>
//               <div>
//                 <div style={{ fontWeight: '600', fontSize: '13px', color: '#0f172a' }}>Safety Focused</div>
//                 <div style={{ fontSize: '12px', color: '#64748b' }}>We'll prioritize immediate actions to keep you safe today.</div>
//               </div>
//             </div>
//           </div>
//           <button
...
//             Takes approximately 2 minutes. You can stop at any time.
//           </p>
//         </div>
//         <div style={{ position: 'absolute', bottom: '8px', fontSize: '11px', color: '#cbd5e1', textAlign: 'center' }}>
//           NO ACCOUNT REQUIRED · LOCAL-ONLY EVIDENCE VAULT · CONFIDENTIAL & SECURE
//         </div>
//       </div>
//     );
//   }
...
//         <div>
//           <div style={{ fontSize: '15px', fontWeight: '600', color: '#0f172a' }}>Safe Exit Planner</div>
//           <div style={{ fontSize: '11px', color: '#94a3b8' }}>Private · Personalised · Step-by-step</div>
//         </div>
//         <div style={{
//           marginLeft: 'auto',
//           background: '#f0fdf4',
...
//             {msg.type === 'welcome' || msg.type === 'text' || msg.type === 'pointwise' ? (
...
//                 <div style={{ ...s.bubble('assistant'), marginBottom: '10px' }}>
//                   {msg.content}
//                 </div>
//                 {/* Only show options for last option-type assistant message */}
//                 {i === messages.length - 1 && (
//                   <div>
...
//             <span style={{ animation: 'pulse 1s infinite' }}>SafeVoice is thinking...</span>
//           </div>
//         )}
//         <div ref={bottomRef} />
//       </div>
...
//         CONFIDENTIAL AI ASSISTANT · NO ACCOUNT REQUIRED · LOCAL ONLY
//       </div>
//     </div>
//   );
// }

// // Renders AI response with numbered points, bold headers, etc.
...
//               <span style={{ color: '#0ea5e9', fontWeight: '700', minWidth: '18px', fontSize: '13px' }}>
